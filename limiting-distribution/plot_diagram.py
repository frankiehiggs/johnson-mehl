...
# def OLD_jm_diagram(colours):
    ...
    # ax.plot(my_range, c_limit, colours[1],linestyle='dashed',linewidth=1.5,label="Limiting cdf of $g(T_\\rho,\\rho)$ (from Thm 2.2)")
...
def jm_diagram(colours):
    ...
    ax.plot(my_range, u_limit, colours[-2],linestyle='dashed',linewidth=1.5,label="Limiting cdf of $g(\\tilde T_\\rho,\\rho)$ (from Prop 2.1)")
